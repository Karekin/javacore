package io.github.dunwu.javacore.concurrent.current.patterns.lockordering;


/**
 * 描述:
 * 处理锁顺序问题 （防止死锁）@link io.github.dunwu.javacore.concurrent.current.features.synchronizedcase.SynchronizedResolveDeadLock.SortExeAccount
 * 适用场景：处理多个锁时
 * @author zed
